...
![![Alt text](image-1.png)](../../../public/images/img-in-posting/image-1.png)

- PROJECT : 릴레이션에서 수직적 부분으로 집합(속성의 값)을 구하는 연산으로 원하는 속성을 추출하기 위한 연산.

![![Alt text](image-2.png)](../../../public/images/img-in-posting/image-2.png)

- JOIN : 두 테이블로부터 조건에 맞는 관련된 튜플들을 하나의 튜플로 결합하여 하나의 테이블로 만드는 연산

![![Alt text](image-3.png)](../../../public/images/img-in-posting/image-3.png)

- DIVISION : A, B 두 테이블에 대해 'A DIVISION B'는 B 테이블의 조건을 만족하는 튜플들을 테이블 A에서 추출하는 연산

![![Alt text](image-4.png)](../../../public/images/img-in-posting/image-4.png)

![![Alt text](image-10.png)](../../../public/images/img-in-posting/image-10.png)

### 관계 대수

![![Alt text](image-7.png)](../../../public/images/img-in-posting/image-7.png)
...
![![Alt text](image-8.png)](../../../public/images/img-in-posting/image-8.png)
...
- DoS(Denial Of Service, 서비스 거부) : DDoS와 마찬가지로 가용성을 해침
  ...
  - SYN flooding
    ...
    - ![![Alt text](image.png)](../../../public/images/img-in-posting/image.png)
  - UDP 플러딩
...
![![Alt text](image-9.png)](../../../public/images/img-in-posting/image-9.png)
...
![![Alt text](image-6.png)](../../../public/images/img-in-posting/image-6.png)
