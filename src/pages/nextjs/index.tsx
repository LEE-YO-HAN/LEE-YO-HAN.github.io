...
export default function Nextjs({ posts }: { posts: PostGridProps[] }) {
  return (
    <>
      <CategoryHead content="nextjs" backgroundImage="NEXTJS" />
...
export const getStaticProps: GetStaticProps<{
  ...
  const dirPath = join(process.cwd() + "/src" + "/posting", "nextjs");
