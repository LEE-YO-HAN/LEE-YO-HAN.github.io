...
export default function React({ posts }: { posts: MarkDownProps[] }) {
  return (
    <>
      <CategoryHead content="react" backgroundImage="REACT" />
...
export const getStaticProps: GetStaticProps<{
  ...
  const dirPath = join(process.cwd() + "/src" + "/posting", "react");
