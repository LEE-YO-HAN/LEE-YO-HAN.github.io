...
export default function Javascript({ posts }: { posts: MarkDownProps[] }) {
  return (
    <>
      <CategoryHead content="javascript" backgroundImage="JAVASCRIPT" />
...
export const getStaticProps: GetStaticProps<{
  ...
  const dirPath = join(process.cwd() + "/src" + "/posting", "javascript");
